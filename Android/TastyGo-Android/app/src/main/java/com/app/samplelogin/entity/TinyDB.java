...
public class TinyDB {
    ...
    public void putListOrders(String key, ArrayList<Orders> stringList) {
        checkForNullKey(key);
        Orders[] myStringList = (Orders[]) stringList.toArray();
        preferences.edit().putString(key, TextUtils.join("‚‗‚", myStringList)).apply();
    }
...
//    }
//
    public void putListObject(String key, List<Orders> objArray){
    	checkForNullKey(key);
    	Gson gson = new Gson();
